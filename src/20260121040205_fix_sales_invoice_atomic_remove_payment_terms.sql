/*
  # Fix Sales Invoice Atomic - Remove Non-Existent payment_terms Column

  1. Problem
    - RPC function tries to update 'payment_terms' column which doesn't exist
    - Only 'payment_terms_days' exists in sales_invoices table
    - Causing: "column payment_terms does not exist" error

  2. Solution
    - Remove payment_terms from UPDATE statement
    - Keep only payment_terms_days
*/
