/*
  # Fix DC Edit Double Reservation Bug
  
  ## Problem
  edit_delivery_challan() does:
  1. Manual UPDATE batches SET reserved_stock = reserved_stock + 350
  2. INSERT INTO delivery_challan_items
  3. Trigger fires on INSERT and tries to reserve ANOTHER 350kg
  4. Total = 700kg reserved!
  
  ## Solution
  Use session variable to tell trigger to skip during RPC execution
*/
